...
fn main() -> Result<()> {
    ...
    let proto_files = [
        ...
        "protos/device.proto",
        "protos/add_device_request.proto",
    ...
    for proto_file in proto_files.iter() {
        ...
        proto_path.pop(); // Remove the 'src-tauri' directory
    ...
    includes_path.pop(); // Remove the 'app' directory
    includes_path.pop(); // Remove the 'src-tauri' directory
